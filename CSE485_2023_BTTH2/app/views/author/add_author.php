            ...
            <div class="col-sm">
                ...
                <form action="index.php?controller=Author&action=store" method="post" enctype="multipart/form-data">
                    <div class="input-group mt-3 mb-3">
                        ...
                        <input type="text" class="form-control" placeholder="Tên tác giả" aria-label="Username" aria-describedby="basic-addon1" name="txtAuthorName" required>
                    </div>
                    <div class="input-group mb-3">
                        <input type="file" class="form-control" id="inputGroupFile02" name="fileAuthorImage" accept="image/jpeg,image/jpg,image/png" required>
