    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                ...
                <form action="./progress/progress_edit_author.php" method="post">
                    <input type="hidden" name="txtAuthorId" value="<?php echo $row["ma_tgia"]; ?>">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="basic-addon1">Tên tác giả</span>
                        <?php
                        echo '<input type="text" class="form-control" placeholder="Tên tác giả" aria-label="Username" aria-describedby="basic-addon1" name="txtAuthorName" value="' . $row['ten_tgia'] . '">';
                        ?>
                    </div>
