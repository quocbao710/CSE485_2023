    ...
    <main class="container mt-5 mb-5">
        <div class="row">
            <div class="col-sm">
                ...
                <form action="./progress/progress_add_author.php" method="post">
                    <div class="input-group mt-3 mb-3">
                        <span class="input-group-text" id="basic-addon1">Tên tác giả</span>
                        <input type="text" class="form-control" placeholder="Tên tác giả" aria-label="Username" aria-describedby="basic-addon1" name="txtAuthorName">
                    </div>
